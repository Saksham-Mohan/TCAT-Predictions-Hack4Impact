...
def parse_by_seconds(timer_interval):
    '''
    starts the loop to check livefeed
    checks live feed, cleans data, and saves data to disk every [timer_interval] seconds

    timer_interval: interval for how often you want to check timer
    '''
    threading.Timer(timer_interval, parse_by_seconds).start()
